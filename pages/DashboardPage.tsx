  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard title="Total Programs" value={programs.length} icon={<FolderIcon className="h-6 w-6"/>} />
        <StatCard title="Total Activities" value={activities.length} icon={<ClipboardDocumentListIcon className="h-6 w-6"/>} />
        <StatCard title="Total Facilities" value={facilities.length} icon={<BuildingOfficeIcon className="h-6 w-6"/>} />
